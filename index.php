<?php get_header() ?>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 mb-5">
                    ...
                    <p class="text-white mb-5">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Debitis sint
                        alias, doloribus assumenda totam porro ex impedit, recusandae voluptatibus sed.</p>
            ...
            <div class="row justify-content-center">
                <div class="col-md-10">
                    <img src="<?php echo get_template_directory_uri();?>/assets/images/book_1.png" alt="Image" class="img-fluid">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="author  d-lg-flex" id="about-section">
        <div class="bg-img" style="background-image: url('<?php echo get_template_directory_uri();?>/assets/images/author_1.jpg');"></div>
        <div class="text">
            ...
            <div class="mt-5">
                ...
                <img src="<?php echo get_template_directory_uri();?>/assets/images/signature.png" alt="Image" class="img-fluid w-25">
            </div>
            ...
            <div class="row">
                    ...
                    <div class="testimonial bg-white h-100">
                        ...
                        <div class="d-flex align-items-center vcard">
                            <figure class="mb-0 mr-3">
                                <img src="<?php echo get_template_directory_uri();?>/assets/images/person_3.jpg" alt="Free website template by Free-Template.co"
                ...
                <div class="col-md-4">
                    <div class="testimonial bg-white h-100">
                        ...
                        <div class="d-flex align-items-center vcard">
                            <figure class="mb-0 mr-3">
                                <img src="<?php echo get_template_directory_uri();?>/assets/images/person_2.jpg" alt="Free website template by Free-Template.co"
                                     class="img-fluid ounded-circle">
                            </figure>
                            <div class="vcard-text">
